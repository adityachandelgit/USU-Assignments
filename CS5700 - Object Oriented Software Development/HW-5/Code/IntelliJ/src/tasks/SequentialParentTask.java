 ...
 */
public class SequentialParentTask extends ParentTask {

    public SequentialParentTask(Builder builder) {
        super(builder);
    }
    ...
    public static class Builder extends Task.Builder<Builder> {
        ...
        public SequentialParentTask build() {
            return new SequentialParentTask(this);
        }
    }
    ...
    public int getOriginalEstimatedTotalHours() {
        ...
        if(listTasks != null) {
            for(Task task : listTasks) {
                ...
                } else if(task.getClass().equals(SequentialParentTask.class)) {
                    totalHours += task.getOriginalEstimatedTotalHours();
                }
            }
        }
